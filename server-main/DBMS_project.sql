...
insert into complaints values(1, 'ctong0', 10001, 1000, 'Charging more fine than listed for traffic offences by threatening people', '2021-12-21 16:20:23', 'Viewed');
insert into complaints values(2, 'egeerts5', 10001, 1000, 'Charging more fine than listed for traffic offences by threatening people', '2021-12-22 12:34:23', 'Not viewed');
insert into complaints values(3, 'nbeagan7', 10002, 1002, "Did not catch a person overspeeding just because he was the son of a minister", '2021-12-21 16:20:23', 'Not viewed');
insert into complaints values(4 , 'gcraske2', 10003, 1003, 'Seen riding without helmet', '2019-03-23 15:20:23', 'viewed');
insert into complaints values(5 , 'ctong0', 10004, 1004, 'Not regular in monitoring traffic', '2021-12-21 16:20:23', 'Not viewed');
